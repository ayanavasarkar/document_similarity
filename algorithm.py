...
#in case no file orr text is entered
if test:
    text = "We received your profile through MoBerries. We start the process with a coding challenge. I am attaching the required files for the challenge. The problem statement is provided vague in purpose. You are free to make assumptions. It would be great if you could get back to us with the challenge. Please feel free to reach out if you have any issues or questions. "
    ...
    algo = Algorithm("SmartStoplist.txt")
